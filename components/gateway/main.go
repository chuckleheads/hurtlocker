...
import (
	...
	gateway "github.com/chuckleheads/hurtlocker/components/gateway/gateway"
...
var (
	...
	swaggerDir = flag.String("swagger_dir", "api/origins", "path to the directory which contains swagger definitions")
)
